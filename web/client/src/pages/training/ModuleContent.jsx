                  ...
                  {q.options.map((opt) => {
                    ...
                    return (
                      <div key={opt.key} style={{
                        ...
                        backgroundColor: isCorrect ? 'rgba(168,85,247,0.1)' : wasSelected ? 'rgba(239,68,68,0.1)' : 'transparent',
                        fontSize: '0.9375rem',
                      }}>
      ...
      <div className="card">
        ...
        <div className="stack-sm">
          {q.options.map((opt) => {
            ...
            let border = '#2A2A2E';
            if (isRevealed) {
              if (opt.key === q.correct_answer) { bg = 'rgba(168,85,247,0.1)'; border = ACCENT; }
              else if (opt.key === selected) { bg = 'rgba(239,68,68,0.1)'; border = '#EF4444'; }
            } else if (opt.key === selected) {
              bg = 'rgba(168,85,247,0.08)'; border = ACCENT;
            }
